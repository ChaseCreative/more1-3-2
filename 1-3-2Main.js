...
*/
    ...
    if (ranISIndex == 0){
      ...
      wrongAnswer1 = nounArray3[randomNoun3Index][3] + " " + verbArray[randomVerbIndex][2] + " " + nounArray[randomObjectIndex][2];
...
shuffle(checkAnswers);
     ...
     wrongAnswer3 = nounArray3[randomNoun3Index][2] + " " + verbArray[randomVerbIndex][2] + " " + nounArray2[randomObject2Index][2];
